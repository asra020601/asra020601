...
- FAISS  
- BM25Okapi  
- SentenceTransformers (Finance2 embeddings)  
...
**Technologies Used**:  
- ScrapeGraphAI (LLMs + graph logic for structured data extraction)  
- Hugging Face (Qwen2.5-72B-Instruct for AI-driven summarization)  
- LangChain Community (context-aware pipelines)  
- Gradio (no-code UI deployment)  
